package extensions.en.kickassanime.extractors

import extensions.en.kickassanime.dto.VideoDto
...
class KickAssAnimeExtractor(
    ...
    fun videosFromUrl(url: String, name: String): List<Video> {
        ...
        System.err.println("name: " + name + ", url: " + videoObject.playlistUrl + ", isblank: " + videoObject.hls.isBlank())
        return when {
