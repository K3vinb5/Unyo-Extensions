...
class Aniwave : ConfigurableAnimeSource, ParsedAnimeHttpSource() {
    ...
    override fun searchAnimeParse(response: Response): AnimesPage {
        ...
        return AnimesPage(animes.reversed(), hasNextPage)
    }
    ...
    override fun episodeListParse(response: Response): List<SEpisode> {
        ...
        return episodeElements.map { episodeFromElements(it, animeUrl) }.reversed()
    }
    ...
    override fun videoListParse(response: Response): List<Video> {
        ...
        val document = response.parseAs<ResultResponse>().toDocument()
        val hosterSelection = preferences.get(PREF_HOSTER_KEY, PREF_HOSTER_DEFAULT.joinToString(",")).split(",").toSet()
        val typeSelection = preferences.get(PREF_TYPE_TOGGLE_KEY, PREF_TYPES_TOGGLE_DEFAULT.joinToString(",")).split(",").toSet()

        return document.select("div.servers > div").flatMap { elem ->
    ...
    override fun List<Video>.sort(): List<Video> {
        ...
        val lang = preferences.get(PREF_LANG_KEY, PREF_LANG_DEFAULT)
